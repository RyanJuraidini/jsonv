jQuery.fn.showLoading = function(options) {
    ...
    if (settings.overlayHeight !== null) {
        ...
        if (jQuery(this)[0] == window.document.body) {
            overlay_height = jQuery(window).height();
        } else {
    ...
    if (settings.hPos.toString().toLowerCase() == 'center') {
        jQuery(loadingDiv).css('left', (indicatorLeft + ((jQuery(overlayDiv).width() - parseInt(jQuery(loadingDiv).width())) * 0.5)).toString() + 'px');
    ...
    if (settings.vPos.toString().toLowerCase() == 'center') {
        jQuery(loadingDiv).css('top', (indicatorTop + ((jQuery(overlayDiv).height() - parseInt(jQuery(loadingDiv).height())) * 0.4)).toString() + 'px');
...
(function() {
    ...
    (function(undefined) {
        ...
        (function(factory) {
                            ...
                            callback: function(subscribable, id) {
                                if (!_isDisposed) {
                                    if (disposalCount && disposalCandidates[id]) {
                                        ...
                                        addDependencyTracking(id, subscribable, isSleeping ? {
                    ...
                    if (childNode) {
                        do {
                            if (captureRemaining)
                                ...
                                var matchingEndComment = getMatchingEndComment(childNode, /* allowUnbalanced: */
                                true);
            ...
            (function() {
                ...
                ko.utils.extend(ko.bindingProvider.prototype, {
                    ...
                    'getBindings': function(node, bindingContext) {
                        ...
                        return ko.components.addBindingsForCustomElement(parsedBindings, node, bindingContext, /* valueAccessors */
                        false);
                    },
                        ...
                        ko.computed(function() {
                            ...
                            ko.components.get(componentName, function(componentDefinition) {
                                ...
                                var componentViewModel = createViewModel(componentDefinition, element, originalChildNodes, componentParams)
                                  , childBindingContext = bindingContext['createChildContext'](componentViewModel, /* dataItemAlias */
            ...
            makeWithIfBinding('ifnot', false /* isWith */
            , true /* isNot */
            );
            ...
            ko.bindingHandlers['options'] = {
                ...
                'update': function(element, valueAccessor, allBindings) {
                    ...
                    } else {// If a falsy value is provided (e.g. null), we'll simply empty the select element
                    }
                ...
                return {
                    ...
                    memoizeBindingAttributeSyntax: function(htmlString, templateEngine) {
                        return htmlString.replace(memoizeDataBindingAttributeSyntaxRegex, function() {
                            return constructMemoizedTagReplacement(/* dataBindAttributeValue: */
                            arguments[4], /* tagToRetain: */
                            arguments[1], /* nodeName: */
...
!function(a) {
    ...
    function c(a) {
        ...
        return function(c, d) {
            if (f.utils.isEmptyVal(c))
                return !0;
            var e, g;
            void 0 === d.typeAttr ? (g = "text",
            e = d) : (g = d.typeAttr,
            e = d.value),
            isNaN(e) || e instanceof Date || (g = "number");
            var h, i, j;
    ...
    function d(a, b, c) {
        return b.validator(a(), void 0 === c.params ? !0 : h(c.params)) ? !0 : (a.setError(f.formatMessage(c.message || b.message, h(c.params), a)),
        !1)
    }
    function e(a, b, c) {
        a.isValidating(!0);
        var d = function(d) {
            var e = !1
              , g = "";
            return a.__valid__() ? (d.message ? (e = d.isValid,
            g = d.message) : e = d,
            e || (a.error(f.formatMessage(g || c.message || b.message, h(c.params), a)),
            a.__valid__(e)),
            void a.isValidating(!1)) : void a.isValidating(!1)
        };
        f.utils.async(function() {
            b.validator(a(), void 0 === c.params ? !0 : h(c.params), d)
        })
    }
    ...
    var m = function() {
        ...
        function e(b, c, d) {
            var f = []
              , g = b.peek ? b.peek() : b;
            b.__kv_traversed !== !0 && (c.options.deep && (b.__kv_traversed = !0,
            c.flagged.push(b)),
            d = void 0 !== d ? d : c.options.deep ? 1 : -1,
            a.isObservable(b) && (b.errors || n.isValidatable(b) || b.extend({
                validatable: !0
            }),
            c.validatables.push(b),
            c.options.live && n.isObservableArray(b) && c.subscriptions.push(b.subscribe(function() {
                c.graphMonitor.valueHasMutated()
            }))),
            g && !g._destroy && (n.isArray(g) ? f = g : n.isObject(g) && (f = n.values(g))),
            0 !== d && n.forEach(f, function(b) {
        ...
        return {
            init: function(a, b) {
                l > 0 && !b || (a = a || {},
                a.errorElementClass = a.errorElementClass || a.errorClass || m.errorElementClass,
                a.errorMessageClass = a.errorMessageClass || a.errorClass || m.errorMessageClass,
                j(m, a),
                m.registerExtenders && f.registerExtenders(),
                l = 1)
            },
            ...
            group: function(b, c) {
                ...
                var e = {
                  ...
                  , f = null;
                return f = c.observable ? a.computed(function() {
                ...
                f.filter = function(a) {
                    ...
                    ,
                    f(),
                    g.arrayFilter(e.validatables, a)
                }
                ,
                f.find = function(a) {
                    return a = a || function() {
                ...
                f._updateState = function(a) {
                    ...
                    return b = a,
                    c.observable ? void e.graphMonitor.valueHasMutated() : (d(a, e),
                    k(e.validatables))
                }
                ,
                f
            ...
            formatMessage: function(a, b, c) {
                if (n.isObject(b) && b.typeAttr && (b = b.value),
                "function" == typeof a)
                    return a(b, c);
                var d = h(b);
                return null == d && (d = []),
                n.isArray(d) || (d = [d]),
                a.replace(/{(\d+)}/gi, function(a, b) {
            ...
            addRule: function(a, b) {
                ...
                var c = !!g.arrayFirst(a.rules(), function(a) {
                    return a.rule && a.rule === b.rule
                });
                return c || a.rules.push(b),
                a
            },
            ...
            writeInputValidationAttributes: function(b, c) {
                ...
                if (d && d.rules) {
                    ...
                    i(f.configuration.html5Attributes, function(c) {
                        ...
                        d && a.computed({
                            read: function() {
                                var e = a.unwrap(d.params);
                                "pattern" === d.rule && e instanceof RegExp && (e = e.source),
                                b.setAttribute(c, e)
                            },
                        ...
                        for (var e in c)
                            if (c.hasOwnProperty(e)) {
                                ...
                                if (b[e]) {
                                    ...
                                    if (a.isObservable(i) && i.extend(k),
                                    j && n.isArray(j))
    ...
    f.rules.required = {
        validator: function(a, b) {
            var c;
            return void 0 === a || null === a ? !b : (c = a,
            "string" == typeof a && (c = String.prototype.trim ? a.trim() : a.replace(/^\s+|\s+$/g, "")),
            b ? (c + "").length > 0 : !0)
        },
    ...
    f.rules.phoneUS = {
        validator: function(a, b) {
            return b ? f.utils.isEmptyVal(a) ? !0 : "string" != typeof a ? !1 : (a = a.replace(/\s+/g, ""),
            b && a.length > 9 && a.match(/^(1-?)?(\([2-9]\d{2}\)|[2-9]\d{2})-?[2-9]\d{2}-?\d{4}$/)) : !0
        },
    ...
    a.bindingHandlers.textInput && f.makeBindingHandlerValidatable("textInput"),
    f.makeBindingHandlerValidatable("selectedOptions"),
    a.bindingHandlers.validationMessage = {
        update: function(b, c) {
            ...
            i = d.isModified && d.isModified(),
            j = d.isValid && d.isValid();
            var k = null;
    ...
    a.bindingHandlers.validationElement = {
        update: function(b, c, d) {
            ...
            i = e.isModified && e.isModified(),
            j = e.isValid && e.isValid();
            var k = function() {
                var a = {}
            ...
            g.errorsAsTitle && a.bindingHandlers.attr.update(b, function() {
    ...
    a.extenders.validatable = function(b, c) {
        ...
        "enable"in c || (c.enable = !0),
        c.enable && !f.utils.isValidatable(b)) {
            ...
            b.setError = function(a) {
                ...
                b.error(a),
                b.__valid__(!1),
                c === a || d || b.isValid.notifySubscribers()
            }
            ,
    ...
    ;
    var n, o = {};
    f.defineLocale = function(a, b) {
        return a && b ? (o[a.toLowerCase()] = b,
        b) : null
    }
    ,
    f.locale = function(a) {
    ...
    a.applyBindingsWithValidation = function(b, c, d) {
        ...
        e = d) : e = c,
        f.init(),
        e && (e = j(j({}, f.configuration), e),
        f.utils.setDomData(g, e)),
        a.applyBindings(b, g)
    }
    ;
    ...
    a.validatedObservable = function(b, c) {
        if (!c && !f.utils.isObject(b))
            return a.observable(b).extend({
                validatable: !0
            });
        var d = a.observable(b);
        return d.errors = f.group(f.utils.isObject(b) ? b : {}, c),
        d.isValid = a.observable(0 === d.errors().length),
        a.isObservable(d.errors) ? d.errors.subscribe(function(a) {
            d.isValid(0 === a.length)
        }) : a.computed(d.errors).subscribe(function(a) {
            d.isValid(0 === a.length)
        }),
        d.subscribe(function(a) {
            f.utils.isObject(a) || (a = {}),
            d.errors._updateState(a),
            d.isValid(0 === d.errors().length)
        }),
        d
    }
});
...
var Newtonsoft;
(function(Newtonsoft) {
    Newtonsoft.roles = ["Customer", "ChildAccount", "Administrator"];
    var ProductType;
    (function(ProductType) {
        ProductType[ProductType["License"] = 1] = "License";
        ProductType[ProductType["Subscription"] = 2] = "Subscription";
    }
    )(ProductType = Newtonsoft.ProductType || (Newtonsoft.ProductType = {}));
    ...
    Newtonsoft.getParameterByName = getParameterByName;
    function showLoading(selector) {
        var element = $(selector);
        element.showLoading();
    }
    Newtonsoft.showLoading = showLoading;
    function hideLoading(selector) {
        var element = $(selector);
        element.hideLoading();
    }
    Newtonsoft.hideLoading = hideLoading;
    function formatDate(isoDate) {
        var date = parseIsoDatetime(isoDate);
        var s = date.getFullYear() + "-" + (date.getMonth() + 1) + "-" + date.getDate();
        return s;
    }
    Newtonsoft.formatDate = formatDate;
    function parseIsoDatetime(isoDate) {
        var dt = isoDate.split(/[: T-]/).map(parseFloat);
        return new Date(dt[0],dt[1] - 1,dt[2],dt[3] || 0,dt[4] || 0,dt[5] || 0,0);
    }
    Newtonsoft.parseIsoDatetime = parseIsoDatetime;
    function isJson(str) {
        try {
            JSON.parse(str);
        } catch (e) {
    ...
    function setModelErrors(viewModel, modelState) {
        for (var property in modelState) {
            if (modelState.hasOwnProperty(property)) {
                var errorMessage = modelState[property];
                var viewModelProperty = viewModel[property];
                if (viewModelProperty && viewModelProperty.setError) {
                    viewModelProperty.setError(errorMessage);
                }
            }
        }
    }
    function handleFailure(viewModel, result) {
        if (result.responseJSON) {
            var responseMessage = result.responseJSON;
            if (result.status === 400) {
                setModelErrors(viewModel, responseMessage.modelState);
            } else {
                alert(responseMessage.message || 'Unexpected server error.');
            }
        } else {
            alert('Unexpected server error.');
        }
    }
    Newtonsoft.handleFailure = handleFailure;
    ...
    ko.validation.rules['isJson'] = {
        validator: function(val) {
            return isJson(val) === true;
        },
        message: function(params, obs) {
            var ex = isJson(obs());
            var error = ex.toString();
            var message = error.substr(error.lastIndexOf(":") + 1);
            return message;
        }
    };
    ...
    ko.bindingHandlers["clipboard"] = {
        init: function(element, valueAccessor, allBindings, viewModel, bindingContext) {
            ...
            client.on("copy", function(event) {
                ...
                clipboard.setData("text/plain", valueAccessor());
            });
        },
        update: function(element, valueAccessor, allBindings, viewModel, bindingContext) {// This will be called once when the binding is first applied to an element,
    ...
    ko.bindingHandlers["codemirror"] = {
        init: function(element, valueAccessor, allBindingsAccessor) {
            ...
            editor.on("change", function(cm) {
                typed = true;
                allBindingsAccessor().textInput(cm.getDoc().getValue());
                typed = false;
            });
            ...
            doc.setValue(allBindingsAccessor().textInput() || "");
            editor.refresh();
            var wrapperElement = $(editor.getWrapperElement());
            ko.utils.domNodeDisposal.addDisposeCallback(element, function() {
                wrapperElement.remove();
            });
            allBindingsAccessor().textInput.subscribe(function(newValue) {
                if (!typed) {
