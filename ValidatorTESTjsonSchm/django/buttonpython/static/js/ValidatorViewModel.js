...
(function (Newtonsoft) {
    var ValidatorViewModel = /** @class */ (function () {
        function ValidatorViewModel(tokenHeader) {
            var _this = this;
            ...
            this.schemaText(this.tryGetStorageItem("schemaText") || ValidatorViewModel.defaultSchemaText);
            this.jsonText(this.tryGetStorageItem("jsonText") || ValidatorViewModel.defaultJsonText);
            $.ajax("/api/jsonschemastore/catalog", {
                ...
                var selectedName = _this.tryGetStorageItem("selectedSchemaName");
                if (selectedName) {
                    _this.selectedSchemaName(selectedName);
                }
            })
                .always(function () {
